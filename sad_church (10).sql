...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 13, 2018 at 09:57 AM
...
INSERT INTO `tbl_event` (`int_eventID`, `var_eventname`, `var_eventdesc`, `char_type`) VALUES
...
(1, 3, 'Birth Certificate', 'Birth Certificate', 'Copy or Original', 'Ordinary', 'Civil '),
(2, 9, 'Birth Certificate', 'Birth Certificate', 'Copy or Original', 'Ordinary', 'Civil'),
(3, 2, 'Birth Certificate', 'Birth Certificate', 'Copy or Original', 'Ordinary', 'Civil'),
(4, 2, ' Baptismal Certificate', 'Baptismal Certificate', 'Copy or Original', 'Ordinary', 'Church'),
(5, 10, 'Valid ID  ', 'Valid ID of the owner', 'Copy', 'Ordinary', 'Civil'),
(6, 6, 'Birth Certificate', 'Birth Certificate', 'Copy or Original', 'Ordinary', 'Civil'),
(7, 7, 'Birth Certificate', 'Birth Certificate', 'Copy or Original', 'Ordinary', 'Civil'),
(8, 7, 'Death Certificate', 'Death Certificate', 'Copy', 'Ordinary', 'Civil'),
(9, 11, 'Birth Certificate', 'Birth Certificate', 'Copy or Original', 'Ordinary', 'Civil'),
(10, 11, 'Baptismal Certificate', 'Baptismal Certificate', 'Copy or Original', 'Ordinary', 'Church'),
(11, 14, 'Valid ID', 'Valid ID of the person in the certificate', 'Copy', 'Ordinary', 'Civil'),
(12, 13, 'Valid ID', 'Valid ID of the person reserving the facility', 'Copy', 'Ordinary', 'Civil'),
(13, 5, 'Birth Certificate of the Groom', 'Birth Certificate of the Groom', 'Original', 'Ordinary', 'Civil'),
(14, 5, 'Birth Certificate of the Bride', 'Birth Certificate of the Bride', 'Original', 'Ordinary', 'Civil'),
(15, 5, 'Baptismal Certificate of the Groom', 'Baptismal Certificate of the groom with FOR MARRIAGE PUSPOSES ONLY annoitation', 'Original', 'Ordinary', 'Church'),
(16, 5, 'Confirmation Certificate of the Groom', 'Confirmation Certificate of the groom with FOR MARRIAGE PURPOSES ONLY annoitatio', 'Original', 'Ordinary', 'Church'),
(17, 5, 'Baptismal Certificate of the Bride', 'Baptismal Certificate of the bride with FOR MARRIAGE PURPOSES ONLY ', 'Original', 'Ordinary', 'Church'),
(18, 5, 'Confirmation Certificate of the Bride', 'Confirmation Certificate of the bride with FOR MARRIAGE PURPOSES ONLY ', 'Original', 'Ordinary', 'Church'),
(19, 5, 'Canonical Interview', 'Interview with the priest', 'Interview', 'Ordinary', 'Church'),
(20, 5, 'Pre-Cana Seminar', 'Pre-wedding seminar', 'Seminar', 'Ordinary', 'Church'),
(21, 5, 'Marriage Banns', 'Banns', 'Banns', 'Ordinary', 'Church'),
(22, 5, 'Permission from Bride''s Parish', 'Permission/ Letter from the bride''s parish', 'Letter', 'Ordinary', 'Church'),
(23, 5, 'Marriage License', 'License', 'Original', 'Ordinary', 'Church'),
(24, 5, 'Marriage Contract', 'contract', 'Original', 'Ordinary', 'Civil'),
(25, 5, 'NSO CENOMAR', 'NSO Certification of No Marriage', 'Original', 'Ordinary', 'Civil'),
(26, 5, 'Clearance from Chancery Office', 'Clearance (form 3)', 'Clearance', 'Non-ordinary', 'Chancery'),
(27, 5, 'Certification of Freedom to Marry from Embassy', 'Certification for foreigner', 'Original', 'Foreigner', 'Civil'),
(28, 5, 'Certification of Freedom to Marry from Chancery', 'certification, for different cases', 'Certification', 'Non-ordinary', 'Chancery'),
(29, 5, 'Permission for Mixed Marriage from Chancery', 'Permission for non-catholic', 'Original', 'Mixed Marriage', 'Chancery'),
(30, 5, 'Affidavit or Co-habitation', 'for couple living in for more than 5 months', 'Original', 'Living-in', 'Civil'),
(31, 5, 'Affidavit by the applicant with 2 witnesses', 'for no religion', 'Original', 'No religion', 'Civil'),
(32, 5, 'Dispensation from Chancery', 'Dispensation from Chancery for different cases', 'Original', 'Dispensation', 'Chancery'),
(33, 5, 'Decree of Divorced', 'for divorced', 'Original', 'Divorced', 'Civil'),
(34, 5, 'Civil Annulment Decision with Certification of Finality', 'for divorced', 'Original', 'Divorced', 'Civil'),
(35, 5, 'Declaration of Nullity by Catholic Matrimonial Tribunal', 'for divorced', 'Original', 'Divorced', 'Civil'),
(36, 5, 'Copy of marriage cert', 'for divorced', 'Copy or Original', 'Dicvorced', 'Civil'),
(37, 5, 'New copy of Marriage Contract', 'for renewal', 'Original', 'Renewal of vows', 'Civil'),
(38, 5, 'Copy of Death Certificate', 'for widow/widower', 'Original', 'Widow/widower', 'Civil'),
(39, 5, 'Copy of Marriage Contract', 'for widow/widower', 'Copy or Original', 'Widow/widower', 'Civil'),
(40, 5, 'Military Clearance from Immediate Commanding Office', 'for military ', 'Original', 'Military', 'Civil'),
(44, 1, 'Birth Certificate', 'Birth Certificate', 'Copy or Original', 'Ordinary', 'Civil');
...
(4, 5, 'asdfadfadfadfadf', 'yeye', '2018-07-13 07:27:00', '2018-07-13 07:27:00', 'dito lang', 'Open for everyone', 'Approved');
...
--
ALTER TABLE `tbl_eventinfo`
  MODIFY `int_eventinfoID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
--
...
--
ALTER TABLE `tbl_requirements`
  MODIFY `int_requirementID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
--
