...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 26, 2018 at 08:16 PM
...
INSERT INTO `tbl_utilities` (`int_utilitiesID`, `int_eventID`, `int_serviceutilitiesID`, `int_reservationmindays`, `int_reservationmaxdays`, `int_requirementsdays`, `time_duration`, `time_defaulttime`, `var_availabledays`, `time_availablestart`, `time_availableend`, `bool_withpayment`, `double_fee`, `double_addrate`, `int_downpaymentdays`, `int_fullpaymentdays`, `bool_refundable`, `int_refundpercentdays`, `double_refundpercent`, `bool_withageconstraints`, `int_agemin`, `int_agemax`, `char_servicestatus`) VALUES
(1, 1, NULL, 3, 30, 0, '01:00:00', '00:00:00', 'Special', '08:00:00', '05:00:00', 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'Enabled'),
(2, 2, NULL, 14, 90, 0, '01:00:00', '11:00:00', 'Regular', '00:00:00', '00:00:00', 1, 300, 50, NULL, 10, 0, NULL, NULL, 1, 11, 0, 'Enabled'),
(3, 3, NULL, 14, 90, 0, '01:00:00', '11:00:00', 'Regular', '00:00:00', '00:00:00', 1, 300, 50, NULL, 10, 0, NULL, NULL, 1, 0, 11, 'Enabled'),
(4, 4, NULL, 3, 7, 0, '01:00:00', '00:00:00', 'Special', '09:00:00', '17:00:00', 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'Enabled'),
(5, 5, NULL, 120, 365, 60, '01:30:00', '00:00:00', 'Special', '08:00:00', '15:00:00', 1, 7000, 50, 15, 60, 1, 30, 50, 1, 18, 0, 'Enabled'),
(7, 7, NULL, 3, 7, 0, '01:00:00', '00:00:00', 'Special', '09:00:00', '15:00:00', 1, 300, 0, NULL, 2, 0, NULL, NULL, 0, NULL, NULL, 'Enabled'),
(9, 9, NULL, 14, 90, 0, '01:00:00', '00:00:00', 'Special', '08:00:00', '16:00:00', 1, 1000, 50, NULL, 10, 0, NULL, NULL, 0, NULL, NULL, 'Enabled'),
(11, 11, NULL, 14, 90, 0, '01:00:00', '00:00:00', 'Special', '08:00:00', '16:00:00', 1, 1000, 50, NULL, 10, 0, NULL, NULL, 1, 11, 0, 'Enabled'),
(13, NULL, 1, 0, 0, 0, NULL, NULL, NULL, NULL, NULL, 1, 100, 0, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'Enabled'),
(14, NULL, 2, 14, 60, 0, NULL, NULL, NULL, '06:00:00', '20:00:00', 1, 1200, 300, 5, 14, 1, 30, 50, 0, NULL, NULL, 'Enabled'),
(15, NULL, 3, 7, 30, 0, '01:00:00', NULL, NULL, '09:00:00', '15:00:00', 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'Enabled');
...
--
ALTER TABLE `tbl_eventinfo`
  MODIFY `int_eventinfoID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=37;
...
--
ALTER TABLE `tbl_houseblessing`
  MODIFY `int_houseblessID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `tbl_payment`
  MODIFY `int_paymentID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `tbl_relation`
  MODIFY `int_relationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;

--
-- AUTO_INCREMENT for table `tbl_requirements`
--
ALTER TABLE `tbl_requirements`
  MODIFY `int_requirementID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=50;
...
--
ALTER TABLE `tbl_requirementsinevents`
  MODIFY `int_requirementsineventsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=49;
...
--
ALTER TABLE `tbl_sponsors`
  MODIFY `int_sponsorID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
...
--
ALTER TABLE `tbl_voucherevents`
  MODIFY `int_voucherID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
