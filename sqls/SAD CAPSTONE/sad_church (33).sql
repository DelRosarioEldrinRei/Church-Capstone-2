...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2018 at 11:42 PM
...
INSERT INTO `tbl_facility` (`int_facilityID`, `var_facilityname`, `var_facilitydesc`, `int_maxpax`, `var_facilitypicpath`, `var_facilitysize`) VALUES
(1, 'Bro. Roqueto 2nd floor', 'Meetings, training, seminars, workshops', 100, NULL, '\r\n4.9m x 11.5m (16ft x 37ft)'),
(2, 'Bro. Roqueto 3rd floor', 'Meetings, training, seminars, workshops, holiday parties, banquets, receptions, class reunions, anniversary parties, birthday parties, baby showers', 100, NULL, '\r\n4.9m x 11.5m (16ft x 37ft)');
...
CREATE TABLE `tbl_facilityreservation` (
  ...
  `timestamp_reservestart` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
  `timestamp_reserveend` datetime NOT NULL DEFAULT '0000-00-00 00:00:00',
...
INSERT INTO `tbl_houseblessing` (`int_houseblessID`, `int_userID`, `var_owner`, `var_estloc`, `var_ownercontactnum`, `var_owneremailadd`, `date_blessingdate`, `time_blessingstart`, `char_approvalstatus`) VALUES
(16, 11, 'Ebrada, Joan Fe D.', 'Laguna', '09999999999', 'joanfe@yahoo.com', '2018-09-28', '09:00:00', 'Pending');
...
(9, 'Special Baptism', 'It includes adult baptism and special baptism.\r\ntuesday-sat', 'Baptism', 'Enabled', NULL),
(11, 'Special Confirmation', 'espesyal na konpirmasyon', 'Baptism', 'Enabled', NULL);
...
INSERT INTO `tbl_user` (`int_userID`, `var_userlname`, `var_userfname`, `var_usermname`, `char_usergender`, `var_useraddress`, `var_usercontactnum`, `var_username`, `var_useremail`, `var_password`, `char_usertype`, `var_userpicpath`) VALUES
(5, 'Admin', 'admin', 'admin', 'Female', 'Anywhere', '09123456789', 'admin', 'admin@gmail.com', 'admin', 'Admin', NULL),
(6, 'Secretariat', 'Secretariat', 'Secretariat', 'Female', 'Anywhere', '09999999999', 'secretariat', 'secretariat@gmail.com', 'secretariat', 'Secretariat', NULL),
(7, 'Coordinator', 'Coordinator', 'Coordinator', 'Male', 'Anywhere', '09999999999', 'coordinator', 'coordinator@gmail.com', 'coordinator', 'Coordinator', NULL),
(8, 'Catechist', 'Catechist', 'Catechist', 'Female', 'Anywhere', '0999999999', 'catechist', 'catechist', 'catechist', 'Catechist', NULL),
(10, 'Priest', 'Priest', 'Priest', 'Male', 'Anyhwere', '09123456789', 'priest', 'priest@gmail.com', 'priest', 'Priest', NULL),
(11, 'Ebrada', 'Jonalyn Fe', 'Desalisa', 'Female', 'Payatas B Quezon City', '09277475753', 'jonalynfe11', 'jonalynfeebrada11@gmail.com', '123jona', 'Guest', NULL),
(12, 'Macaya', 'Joshua Rae', '', 'Male', 'Caloocan CIty', '09277475711', 'joshuarae', 'joshuarae@gmail.com', '123rae', 'Guest', NULL),
(13, 'Del Rosario', 'Eldrin Rei', 'Pablo', 'Male', 'Valenzuela City', '09277475742', 'eldrinrei', 'asdfwe', '123eldrin', 'Guest', NULL),
(14, 'Peñaverde', 'Norme Ann Joyce', 'Tonzon', 'Female', 'Infanta Quezon', '09277475733', 'normeann', 'normeann', '123norme', 'Guest', NULL),
(15, 'Flores', 'Rachel Maiden', 'Cabuso', 'Female', 'Tondo, Manila', '09999999999', 'rachel', 'rachel@gmail.com', '123rachel', 'Guest', NULL);
...
CREATE TABLE `tbl_utilities` (
  ...
  `var_reservationtype` varchar(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_utilities` (`int_utilitiesID`, `int_eventID`, `int_serviceutilitiesID`, `int_reservationmindays`, `int_reservationmaxdays`, `int_downpaymentdays`, `int_fullpaymentdays`, `int_requirementsdays`, `bool_refundable`, `int_refundpercentdays`, `double_refundpercent`, `int_agemin`, `int_agemax`, `double_fee`, `time_duration`, `double_addrate`, `time_availablestart`, `time_availableend`, `time_defaulttime`, `var_reservationtype`) VALUES
(1, 3, NULL, 14, 90, 10, NULL, 7, 0, NULL, NULL, 0, 11, 300, '01:00:00', 50, '00:00:00', '00:00:00', '11:00:00', 'Regular'),
(2, 9, NULL, 14, 90, 10, NULL, 7, 0, NULL, NULL, 0, NULL, 1000, '01:00:00', 50, '08:00:00', '16:00:00', '00:00:00', 'Special'),
(3, 2, NULL, 14, 90, 10, NULL, 7, 0, NULL, NULL, 11, NULL, 300, '01:00:00', 50, '00:00:00', '00:00:00', '11:00:00', 'Regular'),
(4, 11, NULL, 14, 90, 10, NULL, 7, 0, NULL, NULL, 11, NULL, 1000, '01:00:00', 50, '08:00:00', '16:00:00', '00:00:00', 'Special'),
(5, 4, NULL, 3, 7, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '01:00:00', 0, '09:00:00', '17:00:00', '00:00:00', 'Special'),
(6, 7, NULL, 3, 7, 2, NULL, 0, 0, NULL, NULL, NULL, NULL, 300, '01:00:00', 0, '09:00:00', '15:00:00', '00:00:00', 'Special'),
(9, 5, NULL, 120, 365, 15, 60, 60, 1, 30, 50, 18, 0, 7000, '01:30:00', 50, '08:00:00', '15:00:00', '00:00:00', 'Special'),
(12, 1, NULL, 3, 30, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, '01:00:00', 0, '08:00:00', '05:00:00', '00:00:00', 'Special'),
(13, NULL, 1, 0, 0, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, 100, NULL, NULL, NULL, NULL, NULL, NULL),
(14, NULL, 2, 14, 60, 5, 14, 0, 1, 30, 50, NULL, NULL, 1200, NULL, 300, '06:00:00', '20:00:00', NULL, NULL),
(15, NULL, 3, 7, 30, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, '01:00:00', NULL, '09:00:00', '15:00:00', NULL, NULL);
...
CREATE TABLE `tbl_utilities_client` (
  ...
  `var_officeopen` time NOT NULL,
  `var_officeclose` time NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tbl_utilities_client` (`int_clientID`, `var_clientname`, `var_clientabbv`, `var_clientlocation`, `int_clientzipcode`, `var_clienttelephone`, `var_clientmobile`, `var_clientemail`, `var_clientparishpriest`, `var_officeopen`, `var_officeclose`) VALUES
(1, 'Ina ng Lupang Pangako Parish', 'INLPP', 'Phs. 1 Lupang Pangako Payatas B Quezon City ', 1119, '(02) 500-0239', '09999999999', 'INLPP@yahoo.com', 'Fr. Mike Sandaga', '08:00:00', '17:00:00');
...
(1, 'Special', 3, 'Tuesday'),
(2, 'Special', 4, 'Wednesday'),
(3, 'Special', 5, 'Thursday'),
(4, 'Special', 6, 'Friday'),
(5, 'Special', 7, 'Saturday'),
(6, 'Regular', 1, 'Sunday');
...
--
ALTER TABLE `tbl_eventinfo`
  MODIFY `int_eventinfoID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
...
--
ALTER TABLE `tbl_houseblessing`
  MODIFY `int_houseblessID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tbl_notification`
  MODIFY `int_notifID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tbl_payment`
--
ALTER TABLE `tbl_payment`
  MODIFY `int_paymentID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
ALTER TABLE `tbl_relation`
  MODIFY `int_relationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `tbl_requirements`
--
ALTER TABLE `tbl_requirements`
  MODIFY `int_requirementID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tbl_requirementshouse`
  MODIFY `int_requirementhouseIDs` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_requirementsinevents`
--
ALTER TABLE `tbl_requirementsinevents`
  MODIFY `int_requirementsineventsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
...
--
ALTER TABLE `tbl_services`
  MODIFY `int_eventID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tbl_utlities_availabledays`
  MODIFY `int_availday` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `tbl_eventinfo`
  ADD CONSTRAINT `int_paymentID` FOREIGN KEY (`int_paymentID`) REFERENCES `tbl_payment` (`int_paymentID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `tbl_grd3students`
  ADD CONSTRAINT `int_sectionID` FOREIGN KEY (`int_sectionID`) REFERENCES `tbl_section` (`int_sectionID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `tbl_section`
  ADD CONSTRAINT `int_schoolID` FOREIGN KEY (`int_schoolID`) REFERENCES `tbl_school` (`int_schoolID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `int_userID` FOREIGN KEY (`int_userID`) REFERENCES `tbl_user` (`int_userID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
