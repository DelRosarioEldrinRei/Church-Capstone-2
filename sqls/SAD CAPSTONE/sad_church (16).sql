...
--
-- Table structure for table `tbl_documentrequirements`
--

DROP TABLE IF EXISTS `tbl_documentrequirements`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tbl_documentrequirements` (
  `int_documentrequirementID` int(11) NOT NULL AUTO_INCREMENT,
  `var_requirementname` varchar(45) NOT NULL,
  PRIMARY KEY (`int_documentrequirementID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tbl_documentrequirements`
--

LOCK TABLES `tbl_documentrequirements` WRITE;
/*!40000 ALTER TABLE `tbl_documentrequirements` DISABLE KEYS */;
INSERT INTO `tbl_documentrequirements` VALUES (1,'Valid ID');
/*!40000 ALTER TABLE `tbl_documentrequirements` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tbl_requirementsdocument` (
  ...
  `date_reqreceived` date NOT NULL,
  `int_documentrequirementID` int(11) NOT NULL,
  `bool_reqstatus` tinyint(4) NOT NULL,
  `int_requestID` int(11) NOT NULL,
  PRIMARY KEY (`int_requirementdocumentID`),
  KEY `tbl_fk_1_idx` (`int_documentrequirementID`),
  KEY `tbl_fk_2_idx` (`int_requestID`),
  CONSTRAINT `tbl_fk_1` FOREIGN KEY (`int_documentrequirementID`) REFERENCES `tbl_documentrequirements` (`int_documentrequirementID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
-- Dump completed on 2018-08-09 17:02:34
