...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 30, 2018 at 08:49 PM
...
(1, 'Bro. Roqueto 2nd floor', 'Meetings, training, seminars, workshops', NULL),
(2, 'Bro. Roqueto 3rd floor', 'Meetings, training, seminars, workshops, holiday parties, banquets, receptions, class reunions, anniversary parties, birthday parties, baby showers', NULL);
...
CREATE TABLE `tbl_utilities_facility` (
  ...
  `var_facilitysize` varchar(25) NOT NULL,
  `int_reservationmindays` int(11) NOT NULL,
  `int_reservationmaxdays` int(11) NOT NULL,
  `int_requirementsdays` int(11) NOT NULL,
  ...
  `double_fee` double NOT NULL,
  `time_feeper` time NOT NULL,
  `double_addrate` double NOT NULL,
  `time_addper` time NOT NULL,
  `int_downpaymentdays` int(11) NOT NULL,
  `int_fullpaymentdays` int(11) NOT NULL,
  `bool_refundable` tinyint(1) NOT NULL,
  `int_refunddays` int(11) NOT NULL,
  `int_refundpercent` int(11) NOT NULL,
...
(1, 1, 100, ' 4.9m x 11.5m (16ft x 37f', 14, 60, 0, '0,1,2,3,4,5,6', '06:00:00', '20:00:00', 1, 1000, '04:00:00', 30, '01:00:00', 7, 10, 1, 3, 50, 'Can be reserved'),
...
--
ALTER TABLE `tbl_payment`
  MODIFY `int_paymentID` int(10) NOT NULL AUTO_INCREMENT;
