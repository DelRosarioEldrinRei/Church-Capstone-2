...
INSERT INTO `tbl_eventinfo` VALUES (172,11,5,'2019-10-20','09:00:00','Approved',158,NULL,'Incomplete');
...
CREATE TABLE `tbl_payment` (
  ...
  UNIQUE KEY `var_vouhercode_UNIQUE` (`var_vouhercode`)
...
INSERT INTO `tbl_payment` VALUES (158,7000,NULL,'Unpaid',NULL,NULL,NULL);
...
INSERT INTO `tbl_relation` VALUES (167,172,NULL,'Macaya','Joshua Rae','','Male','Caloocan City','1998-12-22','Caloocan City');
...
INSERT INTO `tbl_requirements` VALUES (223,13,'/img/req/birthCertGroom-1539768050655.jpg',NULL,'2018-10-17 17:20:51','Submitted'),(224,15,NULL,NULL,'2018-10-17 17:20:52','Approved'),(225,47,'/img/req/validIDGroom-1539768050363.jpg',NULL,'2018-10-17 17:20:51','Submitted'),(226,16,NULL,NULL,'2018-10-17 17:20:52','To be submitted'),(227,47,'/img/req/validIDBride-1539768050832.jpg',NULL,'2018-10-17 17:20:51','Submitted'),(228,14,'/img/req/birthCertBride-1539768050945.jpg',NULL,'2018-10-17 17:20:51','Submitted'),(229,17,NULL,NULL,'2018-10-17 17:20:52','To be submitted'),(230,18,NULL,NULL,'2018-10-17 17:20:52','To be submitted'),(231,23,NULL,NULL,'2018-10-17 17:20:52','To be submitted'),(232,24,NULL,NULL,'2018-10-17 17:20:52','To be submitted'),(233,25,NULL,NULL,'2018-10-17 17:20:52','To be submitted');
...
INSERT INTO `tbl_requirementsinevents` VALUES (211,224,172),(212,226,172),(213,223,172),(214,225,172),(215,229,172),(216,227,172),(217,228,172),(218,230,172),(219,231,172),(220,232,172),(221,233,172);
...
INSERT INTO `tbl_sponsors` VALUES (242,172,'rakel plores'),(243,172,'krisaldo santos');
...
INSERT INTO `tbl_utilities` VALUES (1,1,NULL,1,30,0,'01:00:00','00:00:00','2,3,4,5,6','08:00:00','17:00:00',0,0,0,0,0,0,NULL,0,0,0,0,'Enabled',0),(2,2,NULL,14,90,0,'01:00:00','11:00:00','0','12:00:00','12:00:00',1,300,50,0,10,0,NULL,0,1,11,0,'Enabled',0),(3,3,NULL,14,90,0,'01:00:00','11:00:00','0','12:00:00','12:00:00',1,300,50,0,7,0,NULL,0,1,0,11,'Enabled',30),(4,4,NULL,3,7,0,'01:00:00','00:00:00','2,3,4,5,6','09:00:00','17:00:00',0,NULL,NULL,NULL,NULL,0,NULL,NULL,0,NULL,NULL,'Enabled',0),(5,5,NULL,365,730,60,'01:30:00','00:00:00','2,3,4,5,6','08:00:00','15:00:00',1,7000,50,15,60,1,30,50,1,18,0,'Enabled',2),(7,7,NULL,3,7,0,'01:00:00','00:00:00','2,3,4,5,6','09:00:00','15:00:00',1,300,0,NULL,2,0,NULL,NULL,0,NULL,NULL,'Enabled',0),(9,9,NULL,14,90,0,'01:00:00','00:00:00','2,3,4,5,6','08:00:00','16:00:00',1,1000,50,NULL,10,0,NULL,50,0,NULL,NULL,'Enabled',5),(11,11,NULL,14,90,0,'01:00:00','00:00:00','2,3,4,5,6','08:00:00','16:00:00',1,1000,50,NULL,10,0,NULL,NULL,1,11,0,'Enabled',5),(13,NULL,1,0,0,0,'12:00:00',NULL,'0,1,2,3,4,5,6','12:00:00','12:00:00',1,100,0,0,0,0,NULL,0,0,0,0,'Enabled',0),(14,NULL,2,0,0,0,NULL,NULL,'0','00:00:00','00:00:00',1,0,0,0,0,1,NULL,NULL,0,NULL,NULL,'Enabled',0),(15,NULL,3,7,30,0,'01:00:00',NULL,'2,3,4,5,6','09:00:00','03:00:00',0,0,0,0,0,0,NULL,0,0,0,0,'Enabled',0);
...
INSERT INTO `tbl_voucherevents` VALUES (111,172,'2018-10-24','2018-10-17',11,'F9StOdbX');
...
INSERT INTO `tbl_wedbride` VALUES (172,'Lacsina','Gramar','Desuyo','Female','asd','1999-11-12','asd','Filipino','Single','Catholic','asd',0,'ad','Catholic','asd','ad','Catholic','ad','asd',0,NULL,NULL,0,NULL,NULL);
...
CREATE TABLE `tbl_wedcouple` (
  ...
  UNIQUE KEY `int_eventinfoID` (`int_eventinfoID`) USING BTREE,
  KEY `int_weddingstep_idx` (`int_wedstep`),
  CONSTRAINT `int_weddingstep` FOREIGN KEY (`int_wedstep`) REFERENCES `tbl_wedsteps` (`int_weddingsteps`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `tbl_wedcouple` VALUES (171,0,0,NULL,NULL,NULL),(172,0,0,NULL,NULL,NULL);
...
INSERT INTO `tbl_wedgroom` VALUES (172,'Filipino','Single','Catholic','Drriver','Julius Ignacio','Catholic','Caloocan City','Khelle Mackaia','Catholic','Caloocan City','Ina ng lupang pangako',0,NULL,NULL,0,NULL,NULL);
...
-- Dump completed on 2018-10-17 17:55:25
