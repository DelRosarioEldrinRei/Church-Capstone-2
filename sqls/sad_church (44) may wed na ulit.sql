...
INSERT INTO `tbl_baptism` (`int_eventinfoID`, `var_parentmarriageadd`, `var_fatherbplace`, `var_motherbplace`, `var_fathername`, `var_mothername`, `var_contactnum`) VALUES
(4, 'Urban QC', 'malay', 'Quezon City', 'Di Ko Alam', 'Maribeth Battuelo', '09099878765');
...
INSERT INTO `tbl_eventinfo` (`int_eventinfoID`, `int_userID`, `int_eventID`, `date_eventdate`, `time_eventstart`, `char_approvalstatus`, `int_paymentID`) VALUES
(4, 11, 3, '2018-10-21', '10:00:00', 'Pending', 4),
(5, 11, 1, '2018-10-05', '08:30:00', 'Pending', NULL),
(6, 11, 4, '2018-10-05', '08:30:00', 'Pending', NULL),
(7, 11, 5, NULL, '10:00:00', 'Pending', 5);
...
(12, 'ad', 'adf', '/img/req/image-1538461820270.jpg');
...
INSERT INTO `tbl_facilityreservation` (`int_reservationID`, `int_userID`, `int_facilityID`, `var_event`, `var_eventdesc`, `int_attendees`, `datetime_reservestart`, `datetime_reserveend`, `char_reservestatus`, `int_paymentID`) VALUES
(11, 11, 2, 'asdf', 'adf', 234, '2018-10-10 15:00:00', '2018-10-10 11:00:00', 'Pending', NULL),
(12, 11, 2, 'adf', 'adsf', 12, '2018-10-10 15:00:00', '2018-10-10 11:00:00', 'Pending', NULL),
(13, 11, 2, 'asdf', 'asdf', 12, '2018-10-10 15:00:00', '2018-10-10 11:00:00', 'Pending', NULL),
(14, 11, 2, 'asf', 'asdf', 123, '2018-10-10 15:00:00', '2018-10-10 11:00:00', 'Pending', NULL);
...
INSERT INTO `tbl_payment` (`int_paymentID`, `dbl_amount`, `datetime_paymentreceived`, `char_paymentstatus`) VALUES
(1, 300, NULL, 'Unpaid'),
(2, 300, NULL, 'Unpaid'),
(3, 300, NULL, 'Unpaid'),
(4, 300, NULL, 'Unpaid'),
...
(4, 4, 'Aunt/Uncle', 'Battuelo', 'Marie', 'wala', 'Female', 'there', '2015-09-03', 'Quezon City'),
(5, 5, 'Friend', 'Ebrada', 'jonalyn', 'Desalisa', 'Male', 'urban Payatas', '2014-01-28', 'Quezon City'),
(6, 6, 'BF/GF', 'tyurtyu', 'rtyurtyu', 'adsf', 'Female', 'asdfasdf', '2015-03-10', 'sfgsdg'),
(7, 7, NULL, 'Battuelo', 'rtyurtyu', 'Desalisa', 'Male', 'dshcx', '2016-04-06', 'sfgsdg');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_renteditems`
--

CREATE TABLE `tbl_renteditems` (
  `int_renteditemID` int(11) NOT NULL,
  `int_reservationID` int(11) NOT NULL,
...
INSERT INTO `tbl_requirements` (`int_requirementID`, `int_reqtypeID`, `var_reqpath`, `var_reqloc`, `datetime_reqreceived`, `var_reqstatus`) VALUES
(4, 1, '/img/req/image-1538487135960.jpg', NULL, '2018-10-02 21:32:16', 'Submitted'),
(5, 44, '/img/req/image-1538497202578.jpg', NULL, '2018-10-03 00:20:03', 'Submitted'),
(6, 47, '/img/image-1538497348804.jpg', NULL, '2018-10-03 00:22:29', 'Submitted'),
(7, 13, '/img/req/birthCertGroom-1538497987392.jpg', NULL, '2018-10-03 00:33:07', 'Submitted'),
(8, 15, NULL, NULL, '0000-00-00 00:00:00', 'To Be Submitted'),
(9, 47, '/img/req/validIDGroom-1538497987386.jpg', NULL, '2018-10-03 00:33:07', 'Submitted'),
(10, 47, '/img/req/validIDBride-1538497987406.jpg', NULL, '2018-10-03 00:33:07', 'Submitted'),
(11, 16, NULL, NULL, '0000-00-00 00:00:00', 'To be submitted'),
(12, 14, '/img/req/birthCertBride-1538497987429.jpg', NULL, '2018-10-03 00:33:07', 'Submitted'),
(13, 17, NULL, NULL, '0000-00-00 00:00:00', 'To be submitted'),
(14, 18, NULL, NULL, '0000-00-00 00:00:00', 'To be submitted'),
(15, 23, NULL, NULL, '0000-00-00 00:00:00', 'To be submitted'),
(16, 24, NULL, NULL, '0000-00-00 00:00:00', 'To be submitted'),
(17, 25, NULL, NULL, '0000-00-00 00:00:00', 'To be submitted');
...
INSERT INTO `tbl_requirementsfacility` (`int_requirementsfacilityID`, `int_reservationID`, `int_servicereqtypeID`, `var_reqpath`, `datetime_reqreceived`, `char_reqstatus`) VALUES
(4, 11, 4, '/img/req/image-1538481182904.jpg', '2018-10-02 19:53:02', 'Submitted'),
(5, 12, 4, '/img/req/image-1538481264479.jpg', '2018-10-02 19:54:24', 'Submitted'),
(6, 13, 4, '/img/req/image-1538482981413.jpg', '2018-10-02 20:23:01', 'Submitted'),
(7, 14, 4, '/img/req/image-1538486727655.jpg', '2018-10-02 21:25:27', 'Submitted');
...
CREATE TABLE `tbl_requirementshouse` (
  `int_requirementhouseIDs` int(11) NOT NULL,
  `int_houseblessID` int(11) NOT NULL,
  `int_servicereqtypeID` int(11) NOT NULL,
  `var_reqpath` varchar(200) NOT NULL,
  `datetime_reqreceived` datetime NOT NULL,
...
(2, 1, 'Valid ID / Birth Certificate', 'valid ID of the person in the certificate'),
...
(6, 5, 'Mass wedding', 'Kasalang bayan', '2018-07-28 02:44:00', '2018-07-28 02:44:00', 'bro roqueto', 'Open for everyone', 'Approved', ''),
(7, 5, 'Mass Baptism', 'Mass baptism', '2018-10-02 10:45:00', '2018-10-04 10:45:00', 'INLPP', 'Open for everyone', 'Approved', '');
...
CREATE TABLE `tbl_user` (
  ...
  `var_userstatus` varchar(15) NOT NULL,
...
INSERT INTO `tbl_user` (`int_userID`, `var_userlname`, `var_userfname`, `var_usermname`, `char_usergender`, `var_useraddress`, `var_usercontactnum`, `var_username`, `var_useremail`, `var_password`, `char_usertype`, `var_userstatus`, `var_userpicpath`) VALUES
(5, 'Admin', 'admin', 'admin', 'Female', 'Anywhere', '09123456789', 'admin', 'admin@gmail.com', 'admin', 'Admin', 'Active', NULL),
(6, 'Secretariat', 'Secretariat', 'Secretariat', 'Female', 'Anywhere', '09999999999', 'secretariat', 'secretariat@gmail.com', 'secretariat', 'Secretariat', 'Active', NULL),
(7, 'Coordinator', 'Coordinator', 'Coordinator', 'Male', 'Anywhere', '09999999999', 'coordinator', 'coordinator@gmail.com', 'coordinator', 'Coordinator', 'Active', NULL),
(8, 'Catechist', 'Catechist', 'Catechist', 'Female', 'Anywhere', '0999999999', 'catechist', 'catechist', 'catechist', 'Catechist', 'Active', NULL),
(10, 'Priest', 'Priest', 'Priest', 'Male', 'Anyhwere', '09123456789', 'priest', 'priest@gmail.com', 'priest', 'Priest', 'Active', NULL),
(11, 'Ebrada', 'Jonalyn Fe', 'Desalisa', 'Female', 'Payatas B Quezon City', '09277475753', 'jonalynfe11', 'jonalynfeebrada11@gmail.com', '123jona', 'Guest', 'Active', NULL),
(12, 'Macaya', 'Joshua Rae', '', 'Male', 'Caloocan CIty', '09277475711', 'joshuarae', 'joshuarae@gmail.com', '123rae', 'Guest', 'Active', NULL),
(13, 'Del Rosario', 'Eldrin Rei', 'Pablo', 'Male', 'Valenzuela City', '09277475742', 'eldrinrei', 'asdfwe', '123eldrin', 'Guest', 'Active', NULL),
(14, 'Peñaverde', 'Norme Ann Joyce', 'Tonzon', 'Female', 'Infanta Quezon', '09277475733', 'normeann', 'normeann', '123norme', 'Guest', 'Active', NULL),
(15, 'Flores', 'Rachel Maiden', 'Cabuso', 'Female', 'Tondo, Manila', '09999999999', 'rachel', 'rachel@gmail.com', '123rachel', 'Guest', 'Active', NULL),
(16, 'Sandaga', 'Michael', 'Nani', 'Male', 'Bahay Pari Lupang Pangako Payatas B QC', '09999999999', 'mike', 'mikesandaga@gmail.com', '123mikee', 'Priest', 'Active', NULL);
...
INSERT INTO `tbl_utilities` (`int_utilitiesID`, `int_eventID`, `int_serviceutilitiesID`, `int_reservationmindays`, `int_reservationmaxdays`, `int_requirementsdays`, `time_duration`, `time_defaulttime`, `var_availabledays`, `time_availablestart`, `time_availableend`, `bool_withpayment`, `double_fee`, `double_addrate`, `int_downpaymentdays`, `int_fullpaymentdays`, `bool_refundable`, `int_refunddays`, `int_refundpercent`, `bool_withageconstraints`, `int_agemin`, `int_agemax`, `char_servicestatus`) VALUES
(1, 1, NULL, 0, 30, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '08:00:00', '05:00:00', 0, 0, 0, 0, 0, 0, NULL, 0, 0, 0, 0, 'Enabled'),
(2, 2, NULL, 14, 90, 0, '01:00:00', '11:00:00', '0', '12:00:00', '12:00:00', 1, 300, 50, 0, 10, 0, NULL, 0, 1, 11, 0, 'Enabled'),
(3, 3, NULL, 14, 90, 0, '01:00:00', '11:00:00', '0', '12:00:00', '12:00:00', 1, 300, 50, 0, 7, 0, NULL, 0, 1, 0, 11, 'Enabled'),
(4, 4, NULL, 3, 7, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '09:00:00', '17:00:00', 0, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'Enabled'),
(5, 5, NULL, 120, 365, 60, '01:30:00', '00:00:00', '2,3,4,5,6', '08:00:00', '15:00:00', 1, 7000, 50, 15, 60, 1, 30, 50, 1, 18, 0, 'Enabled'),
(7, 7, NULL, 3, 7, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '09:00:00', '15:00:00', 1, 300, 0, NULL, 2, 0, NULL, NULL, 0, NULL, NULL, 'Enabled'),
(9, 9, NULL, 14, 90, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '08:00:00', '16:00:00', 1, 1000, 50, NULL, 10, 0, NULL, NULL, 0, NULL, NULL, 'Enabled'),
(11, 11, NULL, 14, 90, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '08:00:00', '16:00:00', 1, 1000, 50, NULL, 10, 0, NULL, NULL, 1, 11, 0, 'Enabled'),
(13, NULL, 1, 0, 0, 0, '12:00:00', NULL, '0,1,2,3,4,5,6', '12:00:00', '12:00:00', 1, 100, 0, 0, 0, 0, NULL, 0, 0, 0, 0, 'Enabled'),
(14, NULL, 2, 0, 0, 0, NULL, NULL, '0', '00:00:00', '00:00:00', 1, 0, 0, 0, 0, 1, NULL, NULL, 0, NULL, NULL, 'Enabled'),
(15, NULL, 3, 7, 30, 0, '01:00:00', NULL, '2,3,4,5,6', '09:00:00', '03:00:00', 0, 0, 0, 0, 0, 0, NULL, 0, 0, 0, 0, 'Enabled');
...
(1, 1, 100, ' 4.9m x 11.5m (16ft x 37f)', 14, 60, 0, '0,1,2,3,4,5,6', '06:00:00', '20:00:00', 1, 1200, '00:00:12', 300, '00:00:12', 7, 14, 1, 3, 50, 'Can be reserved'),
(2, 2, 200, ' 4.9m x 11.5m (16ft x 37f', 14, 60, 0, '0,1,2,3,4,5,6', '06:00:00', '20:00:00', 1, 1200, '04:00:00', 300, '01:00:00', 7, 10, 1, 3, 50, 'Can be reserved'),
(12, 12, 12, '1', 1, 1, 21, '1,2,3', '01:00:00', '01:00:00', 1, 123, '00:01:23', 123, '00:01:23', 123, 123, 1, 123, 123, 'Can be reserved');
...
INSERT INTO `tbl_voucherevents` (`int_voucherID`, `int_eventinfoID`, `date_issued`, `date_due`, `int_userID`) VALUES
(3, 4, '2018-10-02', '2018-10-09', 11);
...
(7, 'asdf', 'asdf', 'adf', 'Female', 'asdfgh', '2015-03-04', '', 'Filipino', 'Single', 'Catholic', 'asdf', 0, 'asdf', 'Catholic', 'asdf', 'asdf', 'Catholic', 'asdf', 'asdf', 0, NULL, NULL, 0, NULL, NULL);
...
INSERT INTO `tbl_wedcouple` (`int_eventinfoID`, `bool_livingin`, `bool_married`, `date_cprevweddate`, `var_cprevwedplace`) VALUES
(7, 0, 0, NULL, NULL);
...
(7, 'Filipino', 'Single', 'Catholic', 'asdfa', 'asdf', 'Catholic', 'adsf', 'adsf', 'Catholic', 'adf', 'asdf', 0, NULL, NULL, 0, NULL, NULL);
...
ALTER TABLE `tbl_grd3students`
  ...
  ADD KEY `int_sectionID_idx` (`int_sectionID`);
...
--
-- Indexes for table `tbl_renteditems`
--
ALTER TABLE `tbl_renteditems`
  ADD PRIMARY KEY (`int_renteditemID`);
...
ALTER TABLE `tbl_requirementshouse`
  ADD PRIMARY KEY (`int_requirementhouseIDs`),
  ADD KEY `int_servicereqtypeID` (`int_servicereqtypeID`),
...
ALTER TABLE `tbl_school`
  ADD PRIMARY KEY (`int_schoolID`);

--
-- Indexes for table `tbl_section`
--
ALTER TABLE `tbl_section`
  ADD PRIMARY KEY (`int_sectionID`),
  ADD KEY `int_schoolID_idx` (`int_schoolID`),
  ADD KEY `int_userID_idx` (`int_userID`);
...
--
ALTER TABLE `tbl_eventinfo`
  MODIFY `int_eventinfoID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_facility`
--
ALTER TABLE `tbl_facility`
  MODIFY `int_facilityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tbl_facilityreservation`
--
ALTER TABLE `tbl_facilityreservation`
  MODIFY `int_reservationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `tbl_ministry`
  MODIFY `int_ministryID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_payment`
  MODIFY `int_paymentID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_relation`
  MODIFY `int_relationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_renteditems`
--
ALTER TABLE `tbl_renteditems`
  MODIFY `int_renteditemID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_requirements`
--
ALTER TABLE `tbl_requirements`
  MODIFY `int_requirementID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `tbl_requirementsfacility`
  MODIFY `int_requirementsfacilityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `tbl_requirementshouse`
--
ALTER TABLE `tbl_requirementshouse`
  MODIFY `int_requirementhouseIDs` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_requirementsinevents`
--
ALTER TABLE `tbl_requirementsinevents`
  MODIFY `int_requirementsineventsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;

--
-- AUTO_INCREMENT for table `tbl_requirementtype`
--
ALTER TABLE `tbl_requirementtype`
  MODIFY `int_reqtypeID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT for table `tbl_school`
--
ALTER TABLE `tbl_school`
  MODIFY `int_schoolID` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `tbl_section`
--
ALTER TABLE `tbl_section`
  MODIFY `int_sectionID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_services`
  MODIFY `int_eventID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `tbl_sponsors`
  MODIFY `int_sponsorID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `tbl_user`
--
ALTER TABLE `tbl_user`
  MODIFY `int_userID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
ALTER TABLE `tbl_utilities_facility`
  MODIFY `int_utilitiesfacilityID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_voucherevents`
  MODIFY `int_voucherID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `tbl_grd3students`
  ADD CONSTRAINT `int_sectionID` FOREIGN KEY (`int_sectionID`) REFERENCES `tbl_section` (`int_sectionID`);
...
--
ALTER TABLE `tbl_members`
  ADD CONSTRAINT `tbl_ibfk_1` FOREIGN KEY (`int_userID`) REFERENCES `tbl_user` (`int_userID`),
  ADD CONSTRAINT `tbl_ibfk_w` FOREIGN KEY (`int_ministryID`) REFERENCES `tbl_ministry` (`int_ministryID`);
...
--
ALTER TABLE `tbl_section`
  ADD CONSTRAINT `int_schoolID` FOREIGN KEY (`int_schoolID`) REFERENCES `tbl_school` (`int_schoolID`),
  ADD CONSTRAINT `int_userID` FOREIGN KEY (`int_userID`) REFERENCES `tbl_user` (`int_userID`);
