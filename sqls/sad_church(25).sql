...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 27, 2018 at 06:08 PM
...
INSERT INTO `tbl_event` (`int_eventID`, `var_eventname`, `var_eventdesc`) VALUES
...
(1, 5, 'LAKAD sa Summer', 'Workshop for every bodyyyyy~', '0000-00-00 00:00:00', '2018-06-27 02:00:00', 'Bro. Roqueto 1', 'Exclusive', 'Aproved');
...
INSERT INTO `tbl_wedcouple` (`int_eventinfoID`, `bool_livingin`, `bool_married`, `date_cprevweddate`, `var_cprevwedplace`, `date_desireddate`, `time_desiredtime`) VALUES
(9, 0, 0, NULL, NULL, '2018-06-03', '10:00:00');
...
--
ALTER TABLE `tbl_event`
  MODIFY `int_eventID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `tbl_eventapplication`
--
ALTER TABLE `tbl_eventapplication`
  MODIFY `int_eventapplicationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `tbl_eventinfo`
--
ALTER TABLE `tbl_eventinfo`
  MODIFY `int_eventinfoID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `tbl_relation`
  MODIFY `int_relationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `tbl_requirementtype`
  MODIFY `int_reqtypeID` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `tbl_specialevent`
  MODIFY `int_specialeventID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `tbl_sponsors`
--
ALTER TABLE `tbl_sponsors`
  MODIFY `int_sponsorID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
--
