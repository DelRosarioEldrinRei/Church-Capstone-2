...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2018 at 10:14 AM
...
INSERT INTO `tbl_blessing` (`int_eventinfoID`, `var_blessingvenue`, `var_blessingdetails`, `date_desireddate`, `time_desiredtime`) VALUES
(57, 'asdfasdf', 'skdjfkasdf', '2018-08-14', '15:18:00');
...
(55, 57, 'Nephew/Niece', 'Meryam', 'Marian', 'Mali', 'Male', 'asdfasdf', '2018-08-14', 'therehere');
...
(2, '/img/req/image-1534231439884.jpg', NULL, '2018-08-14', 1, 'Submitted');
...
(46, 10, 'Valid ID', 'Valid id', 'Copy', 'Civil');
...
--
ALTER TABLE `tbl_eventapplication`
  MODIFY `int_eventapplicationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
--
-- AUTO_INCREMENT for table `tbl_eventinfo`
--
ALTER TABLE `tbl_eventinfo`
  MODIFY `int_eventinfoID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=58;
--
...
--
ALTER TABLE `tbl_payment`
  MODIFY `int_paymentID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `tbl_relation`
  MODIFY `int_relationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;
--
-- AUTO_INCREMENT for table `tbl_requirements`
--
ALTER TABLE `tbl_requirements`
  MODIFY `int_requirementID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
