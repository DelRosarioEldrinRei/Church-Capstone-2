...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 21, 2018 at 01:28 PM
...
CREATE TABLE `tbl_houseblessing` (
  ...
  `cahr_approvalstatus` char(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tbl_requirementshouse` (
  ...
  `int_houseblessID` int(11) NOT NULL,
  `int_servicereqtypeID` int(11) NOT NULL,
  `datetime_reqreceived` int(11) NOT NULL,
  `char_reqstatus` char(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(10, 'Establishment Blessing', 'House blessing belongs to the special services that our parish offers. ', 'Special Service', 'Enabled', NULL),
...
INSERT INTO `tbl_utilities` (`int_utilitiesID`, `int_eventID`, `int_reservationmindays`, `int_reservationmaxdays`, `int_downpaymentdays`, `int_fullpaymentdays`, `int_requirementsdays`, `bool_refundable`, `int_refundpercentdays`, `double_refundpercent`, `int_agemin`, `int_agemax`, `double_fee`, `time_duration`, `double_addrate`, `time_availablestart`, `time_availableend`, `time_defaulttime`, `var_reservationtype`) VALUES
(1, 3, 14, 90, 10, NULL, 7, 0, NULL, NULL, 0, 11, 300, '01:00:00', 50, '00:00:00', '00:00:00', '11:00:00', 'Regular'),
(2, 9, 14, 90, 10, NULL, 7, 0, NULL, NULL, 0, NULL, 1000, '01:00:00', 50, '08:00:00', '16:00:00', '00:00:00', 'Special'),
(3, 2, 14, 90, 10, NULL, 7, 0, NULL, NULL, 11, NULL, 300, '01:00:00', 50, '00:00:00', '00:00:00', '11:00:00', 'Regular'),
(4, 11, 14, 90, 10, NULL, 7, 0, NULL, NULL, 11, NULL, 1000, '01:00:00', 50, '08:00:00', '16:00:00', '00:00:00', 'Special'),
(5, 4, 3, 7, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '01:00:00', 0, '09:00:00', '17:00:00', '00:00:00', 'Special'),
(6, 7, 3, 7, 2, NULL, 0, 0, NULL, NULL, NULL, NULL, 300, '01:00:00', 0, '09:00:00', '15:00:00', '00:00:00', 'Special'),
(7, 10, 7, 30, NULL, NULL, 0, 0, NULL, NULL, NULL, NULL, NULL, '01:00:00', 0, '09:00:00', '17:00:00', '00:00:00', 'Special'),
(9, 5, 120, 365, 15, 60, 60, 1, 30, 50, 18, 0, 7000, '01:30:00', 50, '08:00:00', '15:00:00', '00:00:00', 'Special'),
(10, 16, 0, 0, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, '00:00:00', 0, '00:00:00', '00:00:00', '00:00:00', ''),
(11, 15, 7, 90, NULL, 3, 0, 1, 75, 50, NULL, NULL, 1200, '00:00:00', 300, '06:00:00', '20:00:00', '00:00:00', ''),
(12, 1, 3, 30, NULL, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, '01:00:00', 0, '08:00:00', '05:00:00', '00:00:00', 'Special');
...
--
ALTER TABLE `tbl_eventinfo`
  MODIFY `int_eventinfoID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_payment`
  MODIFY `int_paymentID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `tbl_requirementsinevents`
  MODIFY `int_requirementsineventsID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `tbl_utilities`
  MODIFY `int_utilitiesID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_requirementshouse`
  ADD CONSTRAINT `tbl_requirementshouse_ibfk_1` FOREIGN KEY (`int_houseblessID`) REFERENCES `tbl_houseblessing` (`int_houseblessID`),
