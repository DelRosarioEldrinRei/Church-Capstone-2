...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 17, 2019 at 11:47 PM
...
(50, 5, 'RCIA Certificate of the bride', 'RCIA Certificate of the bride', 'Original', 'Church');
...
INSERT INTO `tbl_utilities` (`int_utilitiesID`, `int_eventID`, `int_serviceutilitiesID`, `int_reservationmindays`, `int_reservationmaxdays`, `int_requirementsdays`, `time_duration`, `time_defaulttime`, `var_availabledays`, `time_availablestart`, `time_availableend`, `bool_withpayment`, `double_fee`, `double_addrate`, `int_downpaymentdays`, `int_fullpaymentdays`, `int_downpaymentpercent`, `bool_refundable`, `int_refunddays`, `int_refundpercent`, `bool_withageconstraints`, `int_agemin`, `int_agemax`, `char_servicestatus`, `int_maxcount`) VALUES
(1, 1, NULL, 1, 30, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '08:00:00', '17:00:00', 0, 0, 0, 0, 0, NULL, 0, NULL, 0, 0, 0, 0, 'Enabled', 0),
(2, 2, NULL, 14, 90, 0, '01:00:00', '11:00:00', '0', '12:00:00', '12:00:00', 1, 300, 50, 0, 10, NULL, 0, NULL, 0, 1, 11, 0, 'Enabled', 0),
(3, 3, NULL, 14, 90, 0, '01:00:00', '11:00:00', '0', '12:00:00', '12:00:00', 1, 300, 50, 0, 7, NULL, 0, NULL, 0, 1, 0, 11, 'Enabled', 30),
(4, 4, NULL, 3, 7, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '09:00:00', '17:00:00', 0, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, NULL, 'Enabled', 0),
(5, 5, NULL, 365, 730, 60, '01:30:00', '00:00:00', '2,3,4,5,6', '08:00:00', '15:00:00', 1, 7000, 50, 15, 60, 50, 1, 30, 50, 1, 18, 0, 'Enabled', 2),
(7, 7, NULL, 3, 7, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '09:00:00', '15:00:00', 1, 300, 0, NULL, 2, NULL, 0, NULL, NULL, 0, NULL, NULL, 'Enabled', 0),
(9, 9, NULL, 14, 90, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '08:00:00', '16:00:00', 1, 1000, 50, NULL, 10, 50, 0, NULL, 50, 0, 18, NULL, 'Enabled', 5),
(11, 11, NULL, 14, 90, 0, '01:00:00', '00:00:00', '2,3,4,5,6', '08:00:00', '16:00:00', 1, 1000, 50, NULL, 10, NULL, 0, NULL, NULL, 1, 11, 0, 'Enabled', 5),
(13, NULL, 1, 0, 0, 0, '12:00:00', NULL, '0,1,2,3,4,5,6', '12:00:00', '12:00:00', 1, 100, 0, 0, 0, NULL, 0, NULL, 0, 0, 0, 0, 'Enabled', 0),
(14, NULL, 2, 0, 0, 0, NULL, NULL, '0', '00:00:00', '00:00:00', 1, 0, 0, 0, 0, NULL, 1, NULL, NULL, 0, NULL, NULL, 'Enabled', 0),
(15, 12, 3, 7, 30, 0, '01:00:00', NULL, '2,3,4,5,6', '09:00:00', '03:00:00', 0, 0, 0, 0, 0, NULL, 0, NULL, 0, 0, 0, 0, 'Enabled', 0);
...
CREATE TABLE `tbl_wedcouple` (
  ...
  `var_folderloc` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
ALTER TABLE `tbl_payment`
  MODIFY `int_paymentID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
...
--
ALTER TABLE `tbl_relation`
  MODIFY `int_relationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT for table `tbl_requirements`
--
ALTER TABLE `tbl_requirements`
  MODIFY `int_requirementID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
...
--
ALTER TABLE `tbl_requirementsinevents`
  MODIFY `int_requirementsineventsID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=134;
...
--
ALTER TABLE `tbl_sponsors`
  MODIFY `int_sponsorID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `tbl_voucherevents`
  MODIFY `int_voucherID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
