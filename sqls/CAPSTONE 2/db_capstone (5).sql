...
INSERT INTO `tbl_eventinfo` (`int_eventinfoID`, `int_userID`, `int_eventID`, `date_eventdate`, `time_eventstart`, `char_approvalstatus`, `int_paymentID`, `int_userpriestID`, `bool_priestrequested`, `char_requirements`, `date_approval`, `date_applied`) VALUES
(5, 11, 5, '2020-02-26', '14:30:00', 'Pending', 5, 10, 1, 'Incomplete', '0000-00-00', '2019-02-11');
...
INSERT INTO `tbl_files` (`int_fileID`, `var_fileloc`, `int_requirementID`) VALUES
(108, 'A-1Q-1', 37),
(109, 'A-1Q-1', 38),
(110, 'A-1Q-1', 39),
(111, 'A-1Q-1', 42),
...
INSERT INTO `tbl_payment` (`int_paymentID`, `dbl_amount`, `dbl_balance`, `dbl_downpaymentamount`, `char_paymentstatus`, `datetime_paymentreceived`, `date_downpaymentdeadline`, `date_fullpaymentdeadline`, `var_vouchercode`, `date_refundissued`, `date_refunddue`) VALUES
(5, 7550, 0, 3525, 'Paid', '2019-02-11 03:19:18', '2019-02-26', '2019-04-12', 'l1vMUWxb', NULL, NULL);
...
(5, 5, NULL, 'asd', 'fasd', 'fads', 'Male', 'asdf', '1998-11-11', 'asdf');
...
(36, 13, '/img/req/birthCertGroom-1549824621786.jpg', '2019-02-11 02:50:22', 'Submitted'),
(37, 49, NULL, '2019-02-11 03:17:32', 'Approved'),
(38, 17, NULL, '2019-02-11 03:38:38', 'Approved'),
(39, 23, NULL, '2019-02-11 03:38:38', 'Approved'),
(40, 46, '/img/req/validIDGroom-1549824621785.jpg', '2019-02-11 02:50:22', 'Submitted'),
(41, 45, '/img/req/validIDBride-1549824621789.jpg', '2019-02-11 02:50:22', 'Submitted'),
(42, 18, NULL, '2019-02-11 03:38:38', 'Approved'),
(43, 24, NULL, NULL, 'To be submitted'),
(44, 14, '/img/req/birthCertBride-1549824621790.jpg', '2019-02-11 02:50:22', 'Submitted'),
(45, 25, NULL, NULL, 'To be submitted'),
(46, 26, NULL, '2019-02-11 03:38:38', 'Approved');
...
INSERT INTO `tbl_schedule` (`int_scheduleID`, `int_userID`, `int_eventinfoID`, `date_sched`, `time_schedstart`, `time_schedend`, `var_venue`, `text_schedulenote`) VALUES
(1, 10, 5, '2020-02-26', '14:30:00', NULL, 'INLPP', NULL);
...
(2, 6, 'asdf', 'asdf', '2019-02-19 09:36:00', '2019-01-24 09:36:00', 'asdf', 'Open for everyone', 'Approved', NULL);
...
(4, 5, '2019-04-12', '2019-02-11', 11, 'l1vMUWxb');
...
(5, 'asdf', 'asdf', 'asdf', 'Female', 'asdf', '1998-11-11', 'asdf', 'Filipino', 'Single', 'Catholic', 'asdf', 0, 'asdf', 'Catholic', 'asd', 'sdf', 'Catholic', 'a', NULL, 1, '1998-11-11', 'asdf', 0, NULL, NULL);
...
(5, 0, 0, NULL, NULL, 4, '', 'A-1Q-1', 'Sandaga, Mike');
...
(5, 'Filipino', 'Single', 'Catholic', 'asdf', 'asd', 'Catholic', 'fasdf', 'asd', 'Catholic', 'fasdf', 'Ina ng Lupang Pangako Parish', 0, NULL, NULL, 0, NULL, NULL);
...
CREATE TABLE `tbl_wedschedule` (
  ...
  `var_schedname` varchar(50) DEFAULT NULL,
  `var_schednotes` varchar(300) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(6, 'Pre-Cana Seminar', 'Pre-Cana Seminar, includes the scheduling of the RCIA/confirmation'),
(7, 'Finalization ', '');
...
ALTER TABLE `tbl_wedschedule`
  ADD PRIMARY KEY (`int_wedschedID`),
  ADD KEY `int_scheduleID` (`int_scheduleID`),
  ADD KEY `int_weddingsteps` (`int_weddingsteps`);
...
--
ALTER TABLE `tbl_eventinfo`
  MODIFY `int_eventinfoID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `tbl_filefolders`
  MODIFY `int_folderID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;

--
-- AUTO_INCREMENT for table `tbl_files`
--
ALTER TABLE `tbl_files`
  MODIFY `int_fileID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=113;
...
--
ALTER TABLE `tbl_relation`
  MODIFY `int_relationID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `tbl_requirements`
--
ALTER TABLE `tbl_requirements`
  MODIFY `int_requirementID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;
...
--
ALTER TABLE `tbl_schedule`
  MODIFY `int_scheduleID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_sponsors`
  MODIFY `int_sponsorID` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
ALTER TABLE `tbl_wedschedule`
  ...
  ADD CONSTRAINT `tbl_wedschedule_ibfk_2` FOREIGN KEY (`int_weddingsteps`) REFERENCES `tbl_wedsteps` (`int_weddingsteps`);
COMMIT;
